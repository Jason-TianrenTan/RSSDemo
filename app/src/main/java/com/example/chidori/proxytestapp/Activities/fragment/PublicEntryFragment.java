...
import com.example.chidori.proxytestapp.Presenter.PublicEntryFragmentPresenter;
import com.example.chidori.proxytestapp.R;

import java.util.ArrayList;
import java.util.List;

public class PublicEntryFragment extends Fragment implements Contract.IPublicEntryFragmentView{
    ...
    private View view;
    private static PublicEntryFragmentPresenter presenter = new PublicEntryFragmentPresenter();
    ...
    public static PublicEntryFragmentPresenter getPresenter(){
        return presenter;
    }
